    ...
    if($valid == 1) {
    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if( $my_ext1=='jpg' || $my_ext1=='JPG' || $my_ext1=='png' || $my_ext1=='PNG' || $my_ext1=='jpeg' || $my_ext1=='JPEG' || $my_ext1=='gif' || $my_ext1=='GIF' ) {
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Old Price<br><span style="font-size:10px;font-weight:normal;">(In GHC)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Current Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In GHC)</span></label>
							<div class="col-sm-4">
